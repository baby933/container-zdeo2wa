...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zdeo2wa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zdeo2wa.containers.anotherwebservice.com/
...
```
git clone git@github.com:baby933/container-zdeo2wa.git
cd container-zdeo2wa
```
...
```
docker attach container-zdeo2wa
```
